...
class OrderCreateSerializer(serializers.Serializer):
    ...
    payment_method = serializers.ChoiceField(choices=['mobile_money','cash_on_delivery','bank_transfer'])
...
class OrderResponseSerializer(serializers.ModelSerializer):
    class Meta:
        model = Order
        fields = ["id", "group_id", "total_amount", "payment_method", "status", "created_at"]