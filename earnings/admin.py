...
class VendorEarningsAdmin(admin.ModelAdmin):
    list_display = [
        'vendor', 'order', 'gross_amount', 'commission_amount', 
        'net_earnings', 'status', 'created_at'
    ]
    ...
    fieldsets = (
        ...
        ('Financial Details', {
            'fields': ('gross_amount', 'commission_rate', 'commission_amount', 'net_earnings')
        }),
        ('Status & Dates', {
            'fields': ('status', 'processed_at', 'paid_at')
        }),
    )
...
class VendorPayoutAdmin(admin.ModelAdmin):
    list_display = [
        'vendor', 'amount', 'payout_method', 'status', 
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('vendor', 'amount', 'payout_method')
        }),
        ('Status & Reference', {
...
class VendorEarningSummaryAdmin(admin.ModelAdmin):
    list_display = [
        'vendor', 'year', 'month', 'total_orders', 
        'gross_sales', 'net_earnings', 'updated_at'
    ]
