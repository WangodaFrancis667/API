...
class VendorEarningsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "net_earnings", "status", "created_at", "processed_at", "paid_at",
            "vendor_info", "order_info"
        ]
...
class VendorPayoutSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = VendorPayout
        fields = [
            "id", "amount", "payout_method", "status", "reference_number",
            "notes", "created_at", "processed_at", "vendor_info"
        ]
...
class VendorEarningSummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "year", "month", "total_orders", "gross_sales",
            "total_commission", "net_earnings", "vendor_info"
        ]
