...
class EarningsModelsTestCase(TestCase):
    ...
    def test_vendor_earnings_creation(self):
        ...
        self.assertEqual(
            str(earnings), f"Earnings for {self.vendor.username} - Order #{order.id}"
        )
...
class EarningsAPITestCase(APITestCase):
    ...
    def test_missing_vendor_params(self):
        ...
        self.assertIn(
            "Either vendor_id or vendor_name parameter is required",
    ...
    def test_vendor_transactions_endpoint(self):
        ...
        response = self.client.get(
            url, {"vendor_id": self.vendor.id, "period": "this_month"}
        )
