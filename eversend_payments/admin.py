...
class TransactionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("User & Account", {"fields": ("uuid", "account_number", "country")}),
        (
            "Financial Details",
...
class CommissionAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        summary = Commission.objects.aggregate(total_commissions=Sum("amount"))
...
class PaymentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("User & Amount", {"fields": ("user_uuid", "amount")}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class EarningAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        summary = Earning.objects.aggregate(total_earnings=Sum("amount"))
        extra_context = extra_context or {}
        extra_context["summary"] = summary
        return super().changelist_view(request, extra_context=extra_context)
